...
class AnagramsSuite {
  ...
  @Test def `subtract a - ()`: Unit = {
    assertEquals(List(('a', 1)), subtract(List(('a', 1)), List()))
    assertEquals(List(('a', 2)), subtract(List(('a', 2)), List()))
    assertEquals(List(('a', 1), ('b', 1)), subtract(List(('a', 1), ('b', 1)), List()))
    assertEquals(List(('b', 1)), subtract(List(('a', 1), ('b', 1)), List(('a', 1))))
    assertEquals(List(('a', 1), ('b', 1)), subtract(List(('a', 2), ('b', 1)), List(('a', 1))))
  }

  @Test def `combinations: [] (8pts)`: Unit =
    assertEquals(List(Nil), combinations(Nil))

  @Test def `combinations of a single letter`: Unit = {
    assertEquals(List(Nil, List(('a', 1))).toSet, combinations(List(('a', 1))).toSet)
    assertEquals(List(Nil, List(('a', 1)), List(('a', 2))).toSet, combinations(List(('a', 2))).toSet)
  }

  @Test def `combinations of two letters`: Unit = {
    assertEquals(List(Nil, List(('a', 1)), List(('b', 1)), List(('a', 1), ('b', 1))).toSet, combinations(List(('a', 1), ('b', 1))).toSet)
  }
  ...
  @Test def `small example`: Unit = {
    assertEquals(List(List("for"), List("fro")).toSet, sentenceAnagrams(List("fro")).toSet)
    assertEquals(List(List("eat"),List("ate"),List("tea")).toSet, sentenceAnagrams(List("eat")).toSet)
  }
